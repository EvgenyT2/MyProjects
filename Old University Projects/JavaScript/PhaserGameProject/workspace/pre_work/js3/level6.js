...
level6.prototype = {
        ...
        //TAUSTA JA MAA
            ...
            map = this.game.add.tilemap('map6', 70, 70);
        ...
        endGame: function(sprite, enemy) {
            ...
            if (oneKill == false){
                ...
                if (oneKill == true){
                    ...
                    var killTween = this.game.add.tween(sprite).to( { alpha: 0 }, 200, null, true, 0, 5, false);
                    music.stop();
