...
level8.prototype = {
        ...
        //TAUSTA JA MAA
            ...
            map = this.game.add.tilemap('map8', 70, 70);
        ...
        WinLevel: function(fairy, tile) {
            if (fairy.key == 'fairy'){
                ...
                if (score>50){
                    ...
                    score += 100;
                    scoreText.text = 'Score: ' + score;
                    var trophy = this.game.add.sprite(this.game.world.camera.x+250, this.game.world.camera.y+60, 'trophy');
                    var trophyTween = this.game.add.tween(trophy.scale).to( { x: 2, y: 2 }, 2000, Phaser.Easing.Bounce.Out, true);
                    trophyTween.onComplete.add(this.winGame, this);
                }}}
            }
         },
