...
var playMode=false;
//oneKill avustaa endGame funktiossa ettei ääntä toisteta uudestaan 
//niin kauan kunnes kutsutaan killFairy fktiota
var oneKill;
...
level1.prototype = {
        ...
        //TAUSTA JA MAA
            ...
            map.setTileIndexCallback(13, this.WinLevel, this);  
        ...
        //peikot
            ...
            //peikko = peikot.create(600, 600, 'otus');
            //peikko.name= 'peikko1';
            //peikko = peikot.create(2000, 200, 'otus');
            //peikko.name= 'peikko2';
            //peikko = peikot.create(800, 600, 'otus');
            //peikko.name= 'peikko3';
        ...
        var mute_button = this.game.add.button(this.game.world.camera.x+1150, this.game.world.camera.y+20, 'mute', this.muteBgSnd, this, null, null, null ); //2, 1, 0);
